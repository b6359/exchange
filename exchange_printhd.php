...
<?php
        ...
        $infodisp = "";
        if (strlen($info) < 20) { $infodisp = $info; } else { $infodisp = substr($info, 0, 18)." ..."; }
?>
...
?>
      <tr>
        <td width="5"></td>
        <td colspan="5"><font size="2.5">Shuma: &nbsp;<b><?php if ($dbcr == "C") { echo "[KR]"; } else { echo "[DB]"; } ?></b></font>&nbsp;&nbsp;<font size="2.5"><b><?php echo number_format($row_exchange_info['vleftapaguar'], 2, '.', ','); ?>&nbsp;<?php echo $info; ?></b></font> &nbsp; &nbsp; </td>
        <td width="5"></td>
      </tr>
      <tr>
        <td colspan="7" height="5"></td>
...
<TABLE cellSpacing=0 cellPadding=0 width="250" border=0>
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <DIV class=ctxheadingP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Faleminderit / Thanks !&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a title="Kthehu pas..." class="link4" href="exchange_hyrdal.php"><img src="images/down_arrow.gif" border="0"></a></DIV></TD>
    </TR>
  </TBODY>
</TABLE>
