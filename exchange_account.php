  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Administrimi i filialeve</DIV></TD>
    </TR>
  </TBODY>
</TABLE>
<br />
...
<table border="0" cellpadding="0" width="100%" cellspacing="0">
  ...
  <tr>
   <th width="5px">  </th>
   <th class="OraColumnHeader"> Filiali </th>
   <th class="OraColumnHeader"> Kod. Llogarie </th>
   <th class="OraColumnHeader"> Menaxher </th>
  ...
  <tr>
    <td></td>
    <td height="2" colspan="5" bgcolor="#000033"></td>
    <td></td>
  </tr>
  <?php
  ...
  <tr>
    <td></td>
    <td align="center"><?php echo $row_h_menu['filiali']; ?></td>
    <td align="center"><?php echo $row_h_menu['kodllogari']; ?></td>
    <td align="center"><?php echo $row_h_menu['administrator']; ?></td>
    <td width="20"><a title="Modifiko Informacionin" href="insupd_account_data.php?action=upd&hid=<?php echo $row_h_menu['id']; ?>"><img src="images/edit.gif" border="0"></a></td>
...
<table width="100%" border="0">
  <tr>
    <td>&nbsp;<input name="insert_dt" type="button"  value="Shto Filial..." onClick="JavaScript: window.location='insupd_account_data.php?action=ins';"></td>
  </tr>
</table>
  <br />
</DIV>
