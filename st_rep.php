...
<div class="ShiritiLogo">
    <div class="logo">
    	...
    	<img src="images/logo.png" title="<?php echo $_SESSION['CNAME']; ?>" alt="<?php echo $_SESSION['CNAME']; ?>" height="50px">
        </a>
    </div>
...
<div id="bar">
    <div class="ButonatFillimi">
    	...
    	<a href="st_rep.php"  class="ButLart2" target="_top"><b>P&euml;rmbledhje e veprimeve</b></a>
    </div>
    <div class="clear"></div>
</div>
  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Raporti p&euml;rmbledh&euml;s</DIV></TD>
    </TR>
  </TBODY>
</TABLE>
<br />
...
?>
  ...
  <tr class="nentitull">
    <td colspan="5" align="center"><script>document.write("<input name=\"repdata\" class=\"inputtext4\" type=\"submit\" value=\"Shfaq raportin...\">");</script></td>
    </td>
  </tr>
  <tr>
    <td height="10" colspan="5"></td>
