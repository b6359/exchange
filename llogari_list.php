...
<head>
    ...
    <script language="JavaScript">
        ...
        function return_value(p_url) {
            ...
            opener.document.formmenu.id_llogari.value = p_url;
...
<body>
    <center>
        ...
        $filiali_info = mysqli_query($MySQL, $query_llogari_info) or die(mysqli_error($MySQL));
                ...
                <td width="80%" align="center">
                    ...
                    <table width="525" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td height="1" width="500" align="center" class="titull"></td>
                            <td height="1" width="10" align="center" class="titull"></td>
                        </tr>
                        <?php while ($row_filiali_info) {  ?>
                            ...
                            <tr bgcolor="#99FFCC">
                                <td class="titull"></td>
                                <td height="16"><a href="JavaScript: return_value('<?php echo $row_filiali_info['kodi']; ?>');" class="link4"><b><?php echo $row_filiali_info['kodi'] . " - " . $row_filiali_info['llogaria']; ?></b></a></td>
                                <td class="titull"></td>
                            </tr>
                        <?php $row_filiali_info = $filiali_info->fetch_assoc();
                        }
