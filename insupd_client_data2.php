...
<body>
    ...
    <div id="bar">
      ...
      -->
            ...
            function openWin() {
                tableWindow = window.open("exchange_tabel.php", " ", "top=100,left=100,width=1280,height=768");
                return 0;
            }
                        ...
                        <form enctype="multipart/form-data" ACTION="insupd_client_data2.php" METHOD="POST"
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                ...
                                <tr>
                                    ...
                                    <td align="left"><input name="emri" type="text" id="emri"
                                            value="<?php echo $emri; ?>" size="50" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">At&euml;sia:</td>
                                    <td align="left"><input name="atesia" type="text" id="atesia"
                                            value="<?php echo $atesia; ?>" size="50" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Mbiemri:</td>
                                    <td align="left"><input name="mbiemri" type="text" id="mbiemri"
                                            value="<?php echo $mbiemri; ?>" size="50" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Emri i kompanis&euml;:</td>
                                    <td align="left"><input name="emrikompanise" type="text" id="emrikompanise"
                                            value="<?php echo $emrikompanise; ?>" size="100" maxlength="150"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Dat&euml;lindja:</td>
                                    <td align="left"><input name="dob" type="text" placeholder="dd.mm.yyyy" id="dob"
                                            value="<?php echo $dob; ?>" size="10" maxlength="10">
                                        <script language="JavaScript">
                                        var o_cal = new tcal({
                                            'formname': 'formmenu',
                                            'controlname': 'dob'
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <select name="gender" id="gender">
                                            <option value="M" <?php if (!(strcmp("M", $gender))) {echo "SELECTED";} ?>>
                                                Mashkull</option>
                                            <option value="F" <?php if (!(strcmp("F", $gender))) {echo "SELECTED";} ?>>
                                                Femer</option>
                                            <option value="C" <?php if (!(strcmp("C", $gender))) {echo "SELECTED";} ?>>
                                                Biznese</option>
                                            <option value="B" <?php if (!(strcmp("B", $gender))) {echo "SELECTED";} ?>>
                                                Banka</option>
                                            <option value="Z" <?php if (!(strcmp("Z", $gender))) {echo "SELECTED";} ?>>
                                                Z.K.Valutor</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <select name="nationality" id="nationality">
                                            <option value="0"
                                                <?php if (!(strcmp("0", $nationality))) {echo "SELECTED";} ?>>Shqiptar
                                            </option>
                                            <option value="1"
                                                <?php if (!(strcmp("1", $nationality))) {echo "SELECTED";} ?>>I Huaj
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left"><input name="nationalitytxt" type="text" id="nationalitytxt"
                                            value="<?php echo $nationalitytxt; ?>" size="35" maxlength="150"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <select name="tipdokumenti" id="tipdokumenti">
                                            <option value="0"
                                                <?php if (!(strcmp("0", $tipdokumenti))) {echo "SELECTED";} ?>>Pasaporte
                                            </option>
                                            <option value="1"
                                                <?php if (!(strcmp("1", $tipdokumenti))) {echo "SELECTED";} ?>>
                                                Leternjoftim</option>
                                            <option value="2"
                                                <?php if (!(strcmp("2", $tipdokumenti))) {echo "SELECTED";} ?>>
                                                Certifikate</option>
                                            <option value="3"
                                                <?php if (!(strcmp("3", $tipdokumenti))) {echo "SELECTED";} ?>>Karte
                                                Kombe tare Identiteti</option>
                                            <option value="4"
                                                <?php if (!(strcmp("4", $tipdokumenti))) {echo "SELECTED";} ?>>Patente
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left"><input name="nrpashaporte" type="text" id="nrpashaporte"
                                            value="<?php echo $nrpashaporte; ?>" size="35" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">NIPT:</td>
                                    <td align="left"><input name="nipt" type="text" id="nipt"
                                            value="<?php echo $nipt; ?>" size="10" maxlength="10"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Telefon:</td>
                                    <td align="left"><input name="telefon" type="text" id="telefon"
                                            value="<?php echo $telefon; ?>" size="35" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Fax:</td>
                                    <td align="left"><input name="fax" type="text" id="fax" value="<?php echo $fax; ?>"
                                            size="35" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">E-mail:</td>
                                    <td align="left"><input name="email" type="text" id="email"
                                            value="<?php echo $email; ?>" size="35" maxlength="100"></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Adresa:</td>
                                    <td align="left"><textarea name="adresa" cols="34" rows="5"
                                            id="adresa"><?php echo $adresa; ?></textarea></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">Dokumenti:</td>
                                    <td align="left"><input name="docname" type="file" id="docname"
                                            value="<?php echo $docname; ?>" size="250"></td>
                                </tr>
                                <tr>
                                    <td width="200">&nbsp;</td>
                                    <td width="400"></td>
                                ...
                                <tr>
                                    <td colspan="2" align="center"><input name="insupd" class="inputtext4" type="submit"
                                            value="Ruaj Informacionin"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
