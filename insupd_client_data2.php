                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <select name="gender" id="gender">
                                                <option value="M" <?php if (!(strcmp("M", $gender))) {
                                                                        echo "SELECTED";
                                                                    } ?>>
                                                    Mashkull</option>
                                                <option value="F" <?php if (!(strcmp("F", $gender))) {
                                                                        echo "SELECTED";
                                                                    } ?>>
                                                    Femer</option>
                                                <option value="C" <?php if (!(strcmp("C", $gender))) {
                                                                        echo "SELECTED";
                                                                    } ?>>
                                                    Biznese</option>
                                                <option value="B" <?php if (!(strcmp("B", $gender))) {
                                                                        echo "SELECTED";
                                                                    } ?>>
                                                    Banka</option>
                                                <option value="Z" <?php if (!(strcmp("Z", $gender))) {
                                                                        echo "SELECTED";
                                                                    } ?>>
                                                    Z.K.Valutor</option>
                                            </select>
