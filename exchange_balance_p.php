  ...
  <TBODY>
    <TR>
      <TD align="left" colSpan=3 height="15">
        <DIV class=ctxheading4><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="left" width="300"><B><?php echo $_SESSION['full_name']; ?>&nbsp;: Bilanci sipas Llogarive</B></td><td align="center" width="200"><a title="Faqja kryesore" class="link4" href="info.php"><img src="images/home.gif" border="0" width="18px"></a>&nbsp;&nbsp;<a title="Administrimi i perdoruesve" class="link4" href="exchange_users.php"><img src="images/user.gif" border="0" width="18px"></a>&nbsp;&nbsp;<a title="Kontakti" class="link4" href="contact.php"><img src="images/contact.gif" border="0" width="18px"></a>&nbsp;&nbsp;<a title="Dalje nga sistemi" class="link4" href="<?php echo $logoutAction ?>"><img src="images/logout.gif" border="0" width="18px"></a></td></tr></table></DIV>
      </TD>
    </TR>
  </TBODY>
</TABLE>
  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <DIV class=ctxheading><B></B></DIV></TD>
    </TR>
  </TBODY>
</TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <DIV class=ctxheading><a title="Print" href="JavaScript: window.print();"><img src="images/print.gif" border="0"></a>&nbsp; &nbsp;</DIV></TD>
    </TR>
  </TBODY>
</TABLE>
<br>
