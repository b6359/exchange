...
?>
        <td>Bler&euml;:</td>
        <td colspan="4" align="right"><b><font size="2"><?php echo number_format($row_exchange_det_info['vleftadebituar'], 2, '.', ','); ?>&nbsp;<?php echo $info; ?></b></font></td>
        <td></td>
      </tr>
      <tr>
        <td></td>
...
<?php  if ($row_exchange_det_info['kursi'] > $row_exchange_det_info['kursi1']) {  ?>
        <td width="*" colspan="4"><?php echo $row_exchange_det_info['kursi_txt']; ?>&nbsp;=&nbsp;1&nbsp;/&nbsp;<font size="2"><?php echo $row_exchange_det_info['kursi']; ?></font></td>
<?php  } else {  ?>
        <td width="*" colspan="4"><?php echo $row_exchange_det_info['kursi1_txt']; ?>&nbsp;=&nbsp;1&nbsp;/&nbsp;<font size="2"><?php echo $row_exchange_det_info['kursi1']; ?></font></td>
<?php  }  ?>
        <td></td>
      </tr>
      <tr>
      ...
      <tr>
        <td></td>
        <td>Total:</td>
        <td colspan="4" align="right"><b><font size="1.7"><?php echo number_format( $row_exchange_det_info['vleftakredituar'], 2, '.', ','); ?>&nbsp;<?php echo $info; ?></b></font></td>
        <td></td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        ...
        <td colspan="2" align="right"><b><font size="2.5"><?php echo number_format( $row_exchange_info['vleftapaguar'], 2, '.', ','); ?>&nbsp;<?php echo $info; ?></font></b></td>
        <td></td>
      </tr>
      <tr>
...
<TABLE cellSpacing=0 cellPadding=0 width="300" border=0>
  <TBODY  style="font-weight: bolder;">
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <DIV class=ctxheadingP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ju Faleminderit! - Thank you!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a title="Kthehu pas..." class="link4" href="exchange.php"><img src="images/down_arrow.gif" border="0"></a></DIV></TD>
    </TR>
  </TBODY>
</TABLE>
