            ...
            <DIV class=ctxheading><br>
              ...
              <table border="0" cellpadding="0" width="100%" cellspacing="0">
                ...
                <tr>
                  ...
                  <th class="OraColumnHeader"> P&euml;rshkrimi </th>
                  <th class="OraColumnHeader"> M. Lokale </th>
                  <th class="OraColumnHeader"> Simboli </th>
                ...
                while ($row_h_menu) { ?>
                  <tr>
                    ...
                    <td width="20"><a title="Modifiko Informacionin" href="insupd_currency_data.php?action=upd&hid=<?php echo $row_h_menu['id']; ?>"><img src="images/edit.gif" border="0"></a></td>
              ...
              <table width="600px" border="0">
                <tr>
                  <td>&nbsp;<input name="insert_dt" type="button" value="Shto Monedhat..." onClick="JavaScript: window.location='insupd_currency_data.php?action=ins';"></td>
                </tr>
              </table>
              <br />
            </DIV>
