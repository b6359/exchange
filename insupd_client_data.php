                  ...
                  <tr>
                    ...
                    <td align="left">
                      <select name="nationality" id="nationality">
                        <option value="0" <?php if (!(strcmp("0", $nationality))) {
                                            echo "SELECTED";
                                          } ?>>Shqiptar</option>
                        <option value="1" <?php if (!(strcmp("1", $nationality))) {
                                            echo "SELECTED";
                                          } ?>>I Huaj</option>
                      </select>
                    </td>
                  ...
                  <tr>
                    ...
                    <td align="left">
                      <select name="tipdokumenti" id="tipdokumenti">
                        <option value="0" <?php if (!(strcmp("0", $tipdokumenti))) {
                                            echo "SELECTED";
                                          } ?>>Pasaporte</option>
                        <option value="1" <?php if (!(strcmp("1", $tipdokumenti))) {
                                            echo "SELECTED";
                                          } ?>>Leternjoftim</option>
                        <option value="2" <?php if (!(strcmp("2", $tipdokumenti))) {
                                            echo "SELECTED";
                                          } ?>>Certifikate</option>
                        <option value="3" <?php if (!(strcmp("3", $tipdokumenti))) {
                                            echo "SELECTED";
                                          } ?>>Karte Kombe tare Identiteti</option>
                        <option value="4" <?php if (!(strcmp("4", $tipdokumenti))) {
                                            echo "SELECTED";
                                          } ?>>Patente</option>
                      </select>
                    </td>
