...
<div id="bar">
    <div class="ButonatFillimi">
    	<a href="exchange_transkl.php" class="ButLart2" target="_top"><b>Lista e transaksioneve</b></a>
    </div>
    <div class="clear"></div>
</div>
  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lista e transaksioneve</DIV></TD>
    </TR>
  </TBODY>
</TABLE>
<br />
...
<table width="100%" border="0">
  <tr>
    ...
    <td ><input name="repdata" class="inputtext4" type="submit" value=" Shfaq transaksionet ... "></td>
    <td >&nbsp;</td>
  </tr>
</table>
<center>
...
?>
  ...
  <tr>
    ...
    <td align="center" class="OraCellGroup2"><?php echo $row_RepInfo['filiali']; ?></td>
    <td align="right"  class="OraCellGroup2"><?php echo number_format($row_RepInfo['vleftadebituar'], 2, '.', ','); ?>&nbsp;<?php echo $row_RepInfo['mon2']; ?>&nbsp;</td>
    <td align="right"  class="OraCellGroup2"><?php echo number_format($v_kursi, 2, '.', ','); ?>&nbsp;&nbsp;</td>
    <td align="right"  class="OraCellGroup2"><?php echo number_format($row_RepInfo['vleftapaguar'], 2, '.', ','); ?>&nbsp;<?php echo $row_RepInfo['mon1']; ?>&nbsp;</td>
