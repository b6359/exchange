...
<?php
  ...
  while ($row_RepInfo) {
     ...
     if (    (($row_RepInfo['mon2'] == "USD") && ($row_RepInfo['mon1'] == "LEK"))
          ...
          || (($row_RepInfo['mon2'] == "EUR") && ($row_RepInfo['mon1'] == "USD"))  ) {    $rowno ++;
...
<?php
        if ($v_b_1n != 0) { $v_b_12 = $v_b_12 / $v_b_1n; }
        if ($v_b_2n != 0) { $v_b_22 = $v_b_22 / $v_b_2n; }
        if ($v_b_3n != 0) { $v_b_32 = $v_b_32 / $v_b_3n; }
?>
...
<?php
  ...
  while ($row_RepInfo) {
     ...
     if (    (($row_RepInfo['mon1'] == "USD") && ($row_RepInfo['mon2'] == "LEK"))
          ...
          || (($row_RepInfo['mon1'] == "EUR") && ($row_RepInfo['mon2'] == "USD"))  ) {    $rowno ++;
