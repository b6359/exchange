...
<div id="bar">
    <div class="ButonatFillimi">
    	...
    	<a href="dt_rep.php"  class="ButLart2" target="_top"><b>Veprimet ditore/periodike</b></a>
  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Raporti i veprimeve ditore/periodike</DIV></TD>
    </TR>
  </TBODY>
</TABLE>
<br />
...
<table width="100%" border="0" class="bordertable">
  ...
  <tr>
    <td height="5"><b>Llogaria:</b></td>
    <td colspan="4">
<select name="id_llogfilial"  id="id_llogfilial">
<?php
...
?>
  ...
  <tr class="nentitull">
    <td colspan="5" align="center"><script>document.write("<input name=\"repdata\" class=\"inputtext4\" type=\"submit\" value=\"Shfaq raportin...\">");</script>
&nbsp; &nbsp; &nbsp; <input name="showfl" class="inputtext4" type="button" value=" Shfaq excel " onClick="JavaScript: document.formmenu.view.value = 'excel'; document.formmenu.submit(); "></td>
    </td>
  </tr>
  <tr>
    <td height="10" colspan="5"></td>
