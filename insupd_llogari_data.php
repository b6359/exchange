...
if ((isset($_POST["form_action"])) && ($_POST["form_action"] == "upd")) {
  $updateSQL = sprintf("UPDATE llogarite SET llogaria=%s, kodi=%s, tipi=%s, veprimi=%s, CHNVL=%s, CHNCO=%s, TRFVL=%s, tstatus=%s WHERE id=%s",
...
if ((isset($_POST["form_action"])) && ($_POST["form_action"] == "ins")) {
  $insertSQL = sprintf("INSERT INTO llogarite (llogaria, kodi, tipi, veprimi, CHNVL, CHNCO, TRFVL, tstatus) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['llogaria'], "text"),
                       GetSQLValueString($_POST['kodi'], "text"),
                       GetSQLValueString($_POST['tipi'], "text"),
                       GetSQLValueString($_POST['veprimi'], "text"),
  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="left" valign="middle">
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Administrimi i llogarive</DIV></TD>
    </TR>
  </TBODY>
</TABLE>
<br />
