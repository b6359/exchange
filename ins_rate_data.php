...
*/
       ...
       if ($v_insert == 1) {
         ...
         //----------------------------------------------------------------------------------------------------------------------------------------------
            $insertSQL = sprintf("INSERT INTO kursi_koka (date, id_llogfilial, fraksion, perdoruesi) VALUES (%s, %s, %s, %s)",
...
<table border="0" cellpadding="0" width="100%" cellspacing="0">
  ...
  <tr valign="middle">
    <td colspan="6"><lable>Dat&euml;:&nbsp;<input name="date" type="text" value="<?php echo strftime('%Y-%m-%d'); ?>"  id="date" size="10" readonly>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <TBODY>
    <TR>
      <TD height="15" colSpan=3 align="center" valign="middle">
        <DIV class=ctxheading><input name="insupd" class="inputtext4" type="button" onClick="JavaScript: document.formmenu.form_action.value = 'ins'; document.formmenu.submit();" value=" Ruaj kursin e k&euml;mbimit "></DIV></TD>
    </TR>
  </TBODY>
</TABLE>
