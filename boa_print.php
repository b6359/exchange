...
/////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ((isset($_POST['rep_type'])) && ($_POST['rep_type'] == "excelnew")) {
     ...
     // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      // Forma F1.1 dhe F1.2
      $v_rowf11 = 8;  $v_rowf21 = 8;
      $v_rowf12 = 8;  $v_rowf22 = 8;
      ...
      $RepInfoM_sql = " select monedha, ((boaorder - 1) * 4) as col
                         ...
                         where monedha <> 'LEK'
                      order by boaorder ";
      $RepInfoMRS   = mysqli_query($MySQL,$RepInfoM_sql) or die(mysql_error());
      ...
      while ($row_RepInfoM) {
       ...
       // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
          ...
          $RepInfoRS   = mysqli_query($MySQL,$RepInfo_sql) or die(mysql_error());
          $row_RepInfo = $RepInfoRS->fetch_assoc();
          $row_vler1 = 0; $row_vler2 = 0; $row_kurs = 0; $row_num = "";
          while ($row_RepInfo) {
  ...
  while ($row_RepInfoM) {
        ...
        $v_mon_b = 0;  $v_mon_rb = 0;
        $v_mon_s = 0;  $v_mon_rs = 0;
  ...
  mysqli_free_result($RepInfoMRS);
    ...
    $v_lek_ib  = 0;     $v_lek_bb  = 0;
    $v_lek_is  = 0;     $v_lek_bs  = 0;
    $v_lek_cb  = 0;     $v_lek_zb  = 0;
    $v_lek_cs  = 0;     $v_lek_zs  = 0;

  while ($row_RepInfo) {

    if ( ($row_RepInfo['mon2'] == "LEK") && ( ($row_RepInfo['gender'] == "M")||
                                              ($row_RepInfo['gender'] == "F")||
                                              ($row_RepInfo['gender'] == "T") ) ) {  $v_lek_ib += $row_RepInfo['vleftadebituar'];  }
    if ( ($row_RepInfo['mon2'] == "LEK") && ($row_RepInfo['gender'] == "B") )     {  $v_lek_bb += $row_RepInfo['vleftadebituar'];  }
    if ( ($row_RepInfo['mon2'] == "LEK") && ($row_RepInfo['gender'] == "C") )     {  $v_lek_cb += $row_RepInfo['vleftadebituar'];  }
    if ( ($row_RepInfo['mon2'] == "LEK") && ($row_RepInfo['gender'] == "Z") )     {  $v_lek_zb += $row_RepInfo['vleftadebituar'];  }

    if ( ($row_RepInfo['mon1'] == "LEK") && ( ($row_RepInfo['gender'] == "M")||
                                              ($row_RepInfo['gender'] == "F")||
                                              ($row_RepInfo['gender'] == "T") ) ) {  $v_lek_is += $row_RepInfo['vleftapaguar'];    }
    if ( ($row_RepInfo['mon1'] == "LEK") && ($row_RepInfo['gender'] == "B") )     {  $v_lek_bs += $row_RepInfo['vleftapaguar'];    }
    if ( ($row_RepInfo['mon1'] == "LEK") && ($row_RepInfo['gender'] == "C") )     {  $v_lek_cs += $row_RepInfo['vleftapaguar'];    }
    if ( ($row_RepInfo['mon1'] == "LEK") && ($row_RepInfo['gender'] == "Z") )     {  $v_lek_zs += $row_RepInfo['vleftapaguar'];    }
  ...
  while ($row_RepInfoM) {
        ...
        $v_mon_a_b = 0;  $v_mon_a_rb = 0;
        $v_mon_a_s = 0;  $v_mon_a_rs = 0;
  ...
  while ($row_RepInfoM) {
        ...
        $v_mon_b_b = 0;  $v_mon_b_rb = 0;
        $v_mon_b_s = 0;  $v_mon_b_rs = 0;
