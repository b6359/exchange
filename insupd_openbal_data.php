...
if ((isset($_POST["form_action"])) && ($_POST["form_action"] == "upd")) {
  $updateSQL = sprintf("UPDATE openbalance SET date_trans=%s, perdoruesi=%s, id_llogfilial=%s, monedha_id=%s, vleftakredituar=%s, rate_value=%s, datarregjistrimit=%s WHERE id=%s",
...
if ((isset($_POST["form_action"])) && ($_POST["form_action"] == "ins")) {
  ...
  $insertSQL = sprintf("INSERT INTO openbalance (date_trans, perdoruesi, id_llogfilial, monedha_id, vleftakredituar, rate_value, datarregjistrimit)
...
?>
           <option value="<?php echo $row_filiali_info['id']; ?>" <?php if (($row_filiali_info['id'] == $_SESSION['Userfilial'])||($row_filiali_info['id'] == $id_llogfilial)) { echo "selected"; } ?>><?php echo $row_filiali_info['filiali']; ?></option>
<?php
         $row_filiali_info = $filiali_info->fetch_assoc();
       }
...
?>
           <option value="<?php echo $row_monedha_info['id']; ?>" <?php if ($row_monedha_info['id'] == $monedha_id) { echo "selected"; } ?>><?php echo $row_monedha_info['monedha']; ?></option>
<?php
         $row_monedha_info = $monedha_info->fetch_assoc();
       }
