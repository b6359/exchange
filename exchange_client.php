...
$sql_info = "SELECT id, emri, mbiemri, emrikompanise, telefon, nrpashaporte, docname ".
  ...
  <tr>
    ...
    <td><a href="doc/<?php if ($row_h_menu['docname'] == "") { echo "bosh.png"; } else { echo $row_h_menu['docname']; } ?>" target="_blank"><img src="doc/<?php if ($row_h_menu['docname'] == "") { echo "bosh.png"; } else { echo $row_h_menu['docname']; } ?>" border="0" width="25px"></a></td>
